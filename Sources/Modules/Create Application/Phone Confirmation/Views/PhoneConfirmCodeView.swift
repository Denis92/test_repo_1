...
protocol PhoneConfirmCodeViewModelProtocol {
  var count: Int { get }
  var filled: Int { get }
}

class PhoneConfirmCodeView: UIView, Configurable {
  // MARK: - Outlets
  ...
  func configure(with viewModel: PhoneConfirmCodeViewModelProtocol) {
