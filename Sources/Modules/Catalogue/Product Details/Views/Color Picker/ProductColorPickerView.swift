//
//  ProductColorPickerView.swift
//  ForwardLeasing
//

import UIKit

class ProductColorPickerView: UIView {
  // MARK: - Properties
  ...
  func configure(with viewModel: ProductColorPickerViewModel) {
...
extension ProductColorPickerView: Configurable {
  typealias ViewModel = ProductColorPickerViewModel
}
